...
function Navbar() {
    ...
    return (
        <nav className="bg-white border-gray-200 dark:bg-black shadow-lg ">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
                <a href="/" className="flex items-center">
                    <img src="/bookstore-logo.png" className="h-20  w-20 mr-3" alt="Company Logo" />
                </a>
                <button
